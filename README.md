...
- The code has been written using .Net Core 3.1 with Visual Studio 2019 IDE.
- The API is hosted in Azure at the location https://wooliesxtechchallengeapi.azurewebsites.net/
